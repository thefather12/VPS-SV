...
v1=$(curl -sSL "https://raw.githubusercontent.com/thefather12/VPS-SV/main//SCRIPT-v8.5x/Main/SCRIPT-v8.5x/Version")
...
repo() {
  link="https://raw.githubusercontent.com/thefather12/Multi-Script/main/Source-List/20.04.list"
  case $1 in
...
post_reboot() {
  echo 'wget -O /root/install.sh "https://raw.githubusercontent.com/thefather12/VPS-SV/main/installer/install-without-key.sh"; clear; sleep 2; chmod +x /root/install.sh; /root/install.sh --continue' >>/root/.bashrc
...
install_continue() {
  os_system
  msg -bar
  echo -e "      \e[5m\033[1;100m   COMPLETAR PAQUETES PARA EL SCRIPT   \033[1;37m"
  msg -bar
...
msg -bar
#-BASH SOPORTE ONLINE
wget https://raw.githubusercontent.com/thefather12/VPS-SV/main/LINKS-LIBRARIES/SPR.sh -O /usr/bin/SPR >/dev/null 2>&1
chmod +x /usr/bin/SPR
...
install_official() {
  clear && clear
  msg -bar
  echo -ne "\033[1;97m ESCRIBE TU RESELLER: \033[1;32m" && read slogan
  tput cuu1 && tput dl1
  echo -e "$slogan"
  msg -bar
  clear && clear
  ...
  wget https://raw.githubusercontent.com/thefather12/VPS-SV/main/LINKS-LIBRARIES/monitor.sh -P /bin/
  ...
  wget -O /bin/resetsshdrop https://raw.githubusercontent.com/thefather12/VPS-SV/main/LINKS-LIBRARIES/resetsshdrop &>/dev/null
  chmod +x /bin/resetsshdrop
  grep -v "^PasswordAuthentication" /etc/ssh/sshd_config >/tmp/passlogin && mv /tmp/passlogin /etc/ssh/sshd_config
  echo "PasswordAuthentication yes" >>/etc/ssh/sshd_config
  rm -rf /usr/local/lib/systemubu1 &>/dev/null
  rm -rf /etc/versin_script &>/dev/null
  v1=$(curl -sSL "https://raw.githubusercontent.com/thefather12/VPS-SV/main/SCRIPT-v8.5x/Version")
  echo "$v1" >/etc/versin_script
  wget -O /etc/versin_script_new https://raw.githubusercontent.com/thefather12/VPS-SV/main/SCRIPT-v8.5x/Version &>/dev/null
  ...
  echo 'clear' >>.bashrc
  echo 'echo ""' >>.bashrc
  echo 'figlet -k VPS-SV | lolcat' >>/root/.bashrc
  echo 'wget -O /etc/versin_script_new https://raw.githubusercontent.com/thefather12/VPS-SV/main/SCRIPT-v8.5x/Version &>/dev/null' >>.bashrc
  echo 'echo "" ' >>.bashrc
  ...
  echo 'echo "" ' >>.bashrc
  echo 'echo -e "\t\033[97mPARA MOSTRAR EL TIPO DE PANEL BASH: sudo menu "' >>.bashrc
  echo 'echo ""' >>.bashrc
  ...
  echo -e "      PARA ENTRAR AL PANEL DIGITE EL COMANDO "
